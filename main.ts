...
game.showLongText("Paper craft 1.0 Arcade Edition", DialogLayout.Bottom)
story.showPlayerChoices("New game", "Continue")
if (story.checkLastAnswer("New game")) {
    game.showLongText("Arrows to move, b to place, A to change, up+right then left+down to save. Materials(shown as the score):0=dirt  1=grass 2=water 3=planks 4=wood 5=leaves 6=air", DialogLayout.Bottom)
    blockSettings.clear()
} else {
